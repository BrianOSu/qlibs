...
.bi.time:{ time.toQEpoch .bi.priv.get["time"]`serverTime}
...
.bi.klinesWithin:{[s;i;st;et] 
    .bi.priv.klines ("symbol";"interval";"startTime";"endTime";"limit")!(s;i;.time.toLinuxEpoch st;.time.toLinuxEpoch et;1000)
 }
